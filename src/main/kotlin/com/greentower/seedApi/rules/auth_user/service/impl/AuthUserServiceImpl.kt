package com.greentower.seedApi.rules.auth_user.service.impl
...
import com.greentower.seedApi.rules.auth_user.domain.repository.AuthUserRepository
...
class AuthUserServiceImpl : AuthUserService, GenericServiceImpl<AuthUser>() {
    ...
    override fun deleteById(id: UUID) {
        val existAuthUser = repositoryAuthUser.findById(id)
